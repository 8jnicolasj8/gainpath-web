    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
      <div style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h2 style={{ marginTop: '1.5rem', fontSize: '1.5rem' }}>Bienvenido de nuevo</h2>
          <p style={{ color: 'var(--text-secondary)', marginTop: '0.5rem' }}>Ingresa para continuar tu progreso</p>
        </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '2rem', color: 'var(--text-secondary)' }}>
          ¿No tienes una cuenta? <Link to="/register" style={{ color: 'var(--primary)', fontWeight: 500 }}>Regístrate</Link>
        </p>
      </div>
    </div>
  );
